...
export const SplOfferData = [
  {
    _id: "201",
    img: 'https://www.lakmeindia.com/cdn/shop/products/Marbel_800x.png?v=1653489278',
    productName: "Light reflecting andvanced skincare foundation",
    price: "35.00",
    product: "Foundations",
    badge: true,
    des: "Advanced makeup-skincare hybrid foundation with medium, buildable coverage and a natural finish.",
  },
  {
    _id: "202",
    img: 'https://blkcosmetics.com.ph/cdn/shop/files/EyePalette_Nude.png?v=1691671219',
    productName: "Luxary Palettes",
    price: "180.00",
    product: "Palletes",
    badge: true,
    des: "blk cosmetics Daydream Eye Palette: Everyday Palette for Eyes + Brows",
  },
  {
    _id: "203",
    img: 'https://media.ulta.com/i/ulta/2604279?w=1020&h=1020',
    productName: "Lipgloss",
    price: "25.00",
    product: "Cosmetics",
    badge: true,
    des: "DiorLip Addict Lip Maximizer Gloss 001 Pink.",
  },
  {
    _id: "204",
    img: 'https://media.ahlens.se/image/upload/f_auto,t_PDPMegazoom/products/bg_removed/65/86/02/65860258_1.jpg',
    productName: "Nature Republic: Skincare",
    price: "220.00",
    product: "Skincare",
    badge: true,
    des: "This soothing gel contains California CCDF certified organic Aloe Vera and mild to skin. Good for moisturizing face, arms, legs and hair. Instant moisturizing without feeling sticky",
  },
];
